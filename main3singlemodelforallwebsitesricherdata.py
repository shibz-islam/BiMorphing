...
def generateModel(traces, runID):
                    ...
                    if packet.getDirection()!=directionCursor:
                        ...
                        if secondBurstAndUp:
                            ...
                            if config.GLOVE_OPTIONS['biBurstSize'] == 1:
                                linesentence = linesentence + " " + biBurstDataKey
            ...
            if config.CLASSIFIER == config.GLOVE_CLASSIFIER:
                ...
                glove.fit(corpus.matrix, epochs=100, no_threads=10, verbose=False)
...
def run():
    try:
        opts, args = getopt.getopt(sys.argv[1:], "t:T:N:k:c:C:d:n:r:B:D:E:F:G:H:I:h")
