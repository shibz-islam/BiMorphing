...
# ow
python mainBiDirectionFeaturesMultipleClassifiersOpenWorldWangTor.py -d 62 -C 3,15,23 -c 0 -k 7 -N 8 -t 100 -T 100 -n 1 -D 1 -E 1 -F 1 -G 1 -H 1 -I 1 -A 1 -V 0 -b 600 -u 960 -i 2 # not cv, benign: 960/2 = 480 train and 480 test
