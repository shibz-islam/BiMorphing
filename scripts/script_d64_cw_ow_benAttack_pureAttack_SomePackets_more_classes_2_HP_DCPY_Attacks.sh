...
do
	...
	# cw
	python mainBiDirectionLatest.py -d 64 -C 3,15,23 -c 0 -k 33 -N 34 -t 16 -T 4 -n 1 -D 1 -E 1 -F 1 -G 1 -H 1 -I 1 -A 1 -V 0 -b 600 -i 14 -w 0 -Q 8 -p $numPackets

	python mainBiDirectionLatest.py -d 64 -C 3,15,23 -c 0 -k 33 -N 34 -t 16 -T 4 -n 1 -D 1 -E 1 -F 1 -G 1 -H 1 -I 1 -A 1 -V 0 -b 600 -i 14 -w 0 -Q 8 -p $numPackets -X 10 # -X cross validation


	# ow
	python mainBiDirectionLatest.py -d 64 -C 3,15,23 -c 0 -k 33 -N 34 -t 100 -T 100 -n 1 -D 1 -E 1 -F 1 -G 1 -H 1 -I 1 -A 1 -V 0 -b 600 -u 200 -i 14 -w 0 -Q 8 -p $numPackets # not cv, benign: 200/2 = 100 train and 100 test

	python mainBiDirectionLatest.py -d 64 -C 3,15,23 -c 0 -k 33 -N 34 -t 100 -T 100 -n 1 -D 1 -E 1 -F 1 -G 1 -H 1 -I 1 -A 1 -V 0 -b 600 -u 200 -i 14 -w 0 -Q 8 -p $numPackets -X 10 # -X cross validation
