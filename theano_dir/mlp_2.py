...
def run_mlp(datasets, n_in, n_out, batch_size, n_hidden, learning_rate, L1_reg, L2_reg, n_epochs):
    """
...
def runDL(files):
    ...
    n_hidden = int(n_dimensions * float(config.DEEP_LEARNING_PARAMETERS['n_hidden_ratio']))  #n_dimensions / 3 #n_dimensions * 2
    ...
    return run_mlp(datasets, n_visible, n_out, batch_size, n_hidden, learning_rate, L1_reg, L2_reg, n_epochs)
