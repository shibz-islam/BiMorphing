...
def load_data(dataset):
    ...
    #numpy.savetxt('testfile.txt', train_set[0])
...
def run_Log_sgd(datasets, n_visible, n_out, batch_size, n_epochs, learning_rate):
    ...
    # construct the logistic regression class
    # Each MNIST image has size 28*28
    classifier = LogisticRegression(input=x, n_in=n_visible, n_out=n_out) # * change here
...
#def calcLog_sgd(files):
def runDL(files):
    print('Running Logistic SGD 2')
    print('#####################')
    ...
    #n_hidden = n_dimensions / 3
    #corruption_level = 0.3

    #datasets, n_visible, n_hidden, corruption_level,

    #hidden_layers_sizes = [10, 10, 10] #[1000, 1000, 1000]
    n_out = numClasses# here get # classes by getData function
    #corruption_levels = [.1, .2, .3]

    batch_size = 10
    n_epochs = 100 #30 # 20 #5 #1000
    learning_rate = 0.13
    run_Log_sgd(datasets, n_visible, n_out, batch_size, n_epochs, learning_rate)  # list of theano shared matrices
