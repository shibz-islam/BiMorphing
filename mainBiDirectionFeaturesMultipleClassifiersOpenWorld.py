...
#                os.mkdir(OSADfolder)
    ...
    for i in range(config.NUM_TRIALS):
        ...
        if (config.NUM_MONITORED_SITES != -1):
            ...
            #monitoredWebpageIdsObj = Utils.convertToIntObj(monitoredWebpageIds); // converting int[] to Integer[] to use indexOf
            #unMonitoredWebpageIdsObj = Utils.convertToIntObj(unMonitoredWebpageIds);
